...
public class BookServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        // Book newBook = new Gson().fromJson(
                // "{'id': 1,'title': 'The Great Gatsby','author': 'F. Scott Fitzgerald','price': 10.99,'qty': 100}",
                // Book.class);
        // System.out.println(newBook);
        // book [id=1, title=The Great Gatsby, author=F. Scott Fitzgerald, price=10.99,// qty=100]
